...
2. Install Opencore to USB Installer. Read the [Vanilla](https://hackintosh.gitbook.io/-r-hackintosh-vanilla-desktop-guide/clover-setup) guide
...
## What works
Everything should work, but you will likely have challenges with Thunderbolt displays. Typically the USB devices attached to the displays (e.g. speakers, camera) would only work after a warm reboot.
...
This GA-Z390-UD mainboard eventually died, so I wont be updating this repo any further. Aside from the normal challenges with Thunderbolt, the machine worked perfectly for 5+ years.
